                ...
                try {
                    if (((KodeInstance) x_).fields.containsKey(Kode.LIST)) {
                        ...
                        if (get instanceof KodeFunction) {
                            return toList(((KodeFunction) get).bind((KodeInstance) x_).call(new Object[0]), a);
                        }
                    }
                    return toList(((KodeInstance) x_).klass.findMethod(Kode.LIST).bind((KodeInstance) x_).call(new Object[0]), a);
