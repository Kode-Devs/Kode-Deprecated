                ...
                try {
                    if (((KodeInstance) x_).fields.containsKey(Kode.NUMBER)) {
                        ...
                        if (get instanceof KodeFunction) {
                            return toNumber(((KodeFunction) get).bind((KodeInstance) x_).call(new Object[0]), a);
                        }
                    }
                    return toNumber(((KodeInstance) x_).klass.findMethod(Kode.NUMBER).bind((KodeInstance) x_).call(new Object[0]), a);
